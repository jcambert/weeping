<template>
    <v-card>
        ...
        <v-list two-line class="pa-0">
            ...
            <v-list-tile href="#" v-for="(equipe,index) in equipes" :key="index">
                <v-list-tile-action>
                    <v-icon color="primary">group</v-icon>
                </v-list-tile-action>
                <v-list-tile-content>
                    <v-list-tile-title>{{equipe.libdivision}}</v-list-tile-title>
                    <v-list-tile-sub-title>{{equipe.libequipe}}</v-list-tile-sub-title>
                </v-list-tile-content>
                <v-list-tile-action>
                    <v-tooltip bottom>
