/**
 * @see https://echarts.apache.org/examples/en/
 * @see https://echarts.apache.org/examples/en/editor.html?c=doc-example/getting-started
 * @see https://echarts.apache.org/examples/en/editor.html?c=line-simple&theme=light
 * @see https://echarts.apache.org/examples/en/editor.html?c=pie-doughnut
 */
...
if (ECharts === undefined) {
  console.error('ECharts is not defined','You must import ECharts library in your HTML head tag');
}
// set color palette
const colorPalette = [];
